...
1. Download the compressed version from Releases page ([2.4.1](https://github.com/paytabscom/paytabs-prestashop1.7/releases/download/2.4.1/paytabs_paypage.zip))
