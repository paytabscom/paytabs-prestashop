...
1. Download the compressed version from Releases page ([3.1.3](https://github.com/paytabscom/paytabs-prestashop1.7/releases/download/3.1.3/paytabs_paypage.zip))
