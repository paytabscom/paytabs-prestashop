...
1. Download the compressed version from Releases page ([3.1.2](https://github.com/paytabscom/paytabs-prestashop1.7/releases/download/3.1.2/paytabs_paypage.zip))
